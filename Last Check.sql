...
SELECT a.name acc_name, r.name reg_name, s.name sales_name
FROM accounts a
JOIN sales_reps s
...
SELECT r.name reg_name, a.name acc_name, o.total_amt_usd/(o.total+0.1) unit_price
FROM orders o
JOIN accounts a
...
SELECT r.name reg_name, a.name acc_name, o.total_amt_usd/(o.total+0.1) AS unit_price
FROM orders o
JOIN accounts a
ON a.id = o.account_id
JOIN sales_reps s
